...
HD_PWD='C:/Users/Rey Messon/Desktop/procesador_mips/project_16/project_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_counter.tcl
