...
HD_PWD='C:/Users/Rey Messon/Desktop/procesador_mips/project_23/project_23.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_procesador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_procesador.tcl
