...
HD_PWD='C:/Users/Rey Messon/Desktop/procesador_mips/project_13/project_13.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_mips.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_mips.tcl
