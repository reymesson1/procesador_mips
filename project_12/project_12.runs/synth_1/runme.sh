...
HD_PWD='C:/Users/Rey Messon/Desktop/procesador_mips/project_12/project_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procesador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procesador.tcl
